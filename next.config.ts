...
const baseContentSecurityPolicy: string[] = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://vitals.vercel-insights.com https://*.vercel-insights.com https://www.google.com https://www.google.es https://www.google-analytics.com https://www.googletagmanager.com",
  "manifest-src 'self'",
